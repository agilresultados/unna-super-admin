/**
 * Códigos de emoji da UIKit da Tencent (`[TUIEmoji_X]`) e o arquivo de imagem
 * correspondente. A biblioteca não exporta essa tabela pelo `exports` do pacote,
 * então ela é copiada de @tencentcloud/chat-uikit-react/src/constant/emoji.ts.
 * Sem isso a prévia da conversa mostra o código traduzido ("[BareTeeth]") em vez
 * do desenho que aparece dentro do chat.
 */
...
export const EMOJI_KEY_REGEX = /(\[TUIEmoji_[A-Za-z0-9_]+\])/g
